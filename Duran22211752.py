...
hipoPI = controlador(4.2164E-5,3267.68674685278,syshipo)
hiperPI = controlador(10,3275.21614803153,syshiper)
...
plt.plot(t,Pp0,'-',linewidth=1, color =clr1, label = 'Pp(t):Normotenso')
plt.plot(t,Pp1,'-',linewidth=1, color =clr2, label = 'Pp(t):Hipotenso')
plt.plot(t,Pp3,':',linewidth=1, color =clr4, label = 'Pp(t):Hipotenso-PI')
plt.grid(False)
plt.xlim(0,10); plt.xticks(np.arange(0,11,1))
plt.ylim(-0.6,1.4); plt.yticks(np.arange(-0.6,1.6,0.2))
plt.xlabel('Pp(t) [V]')
...
plt.plot(t,Pp4,':',linewidth=1, color =clr5, label = 'Pp(t):Hipertenso-PI')
plt.grid(False)
plt.xlim(0,10); plt.xticks(np.arange(0,11,1))
plt.ylim(-0.6,1.4); plt.yticks(np.arange(-0.6,1.6,0.2))
plt.xlabel('Pp(t) [V]')
